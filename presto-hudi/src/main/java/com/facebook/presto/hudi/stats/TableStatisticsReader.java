...
package com.facebook.presto.hudi.stats;
...
public class TableStatisticsReader
{
     ...
     * @param columnHandles a list of {@link HudiColumnHandle} representing the columns for which statistics are needed
            ...
            List<HudiColumnHandle> columnHandles)
    {
        ...
        for (HudiColumnHandle columnHandle : columnHandles) {
        ...
        return TableStatistics.builder()
                ...
                .setColumnStatistics(columnHandleBuilder.buildOrThrow())
                .build();
    }
