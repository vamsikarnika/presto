        ...
        implements ConnectorSplitManager
{
            ...
            SplitSchedulingContext splitSchedulingContext)
    {
        ...
        Lazy<Map<String, Partition>> lazyPartitionMap = Lazy.lazily(() -> {
            ...
            Map<String, Partition> partitions = hudiPartitionManager.getEffectivePartitions(session, metastore, table.getSchemaTableName(), table.getPath(), layout.getPartitionPredicates());
